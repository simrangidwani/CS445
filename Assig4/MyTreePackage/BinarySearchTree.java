...
/**
   ...
   @version 4.0
*/
public class BinarySearchTree<T extends Comparable<? super T>> extends ComparableBinaryTree<T> implements SearchTreeInterface<T>
{
   ...
   private BinaryNode<T> removeLargest(BinaryNode<T> rootNode)
   {
	...
	// **************************************************
        public T getMax()
        {
            return recurseMax(getRootNode());
        }
        
        public T recurseMax(BinaryNode<T> node)
        {
            if (node == null)
            {
                return null;
            ...
            if (node.getRightChild() == null)
            {
                ...
                return recurseMax(node.getRightChild());
        }
        
        public T getMin()
        {
            return recurseMin(getRootNode());
        }
        
        public T recurseMin(BinaryNode<T> node)
        {
            if (node == null)
            {
                return null;               
            ...
            if (node.getLeftChild() == null)
            {
                ...
                return recurseMin(node.getLeftChild());
        }
